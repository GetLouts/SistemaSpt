                            ...
                            <div class="row">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th> Estado : </th>
                                            <td> <span class="badge badge-success">{{ $alumnos->estados->estado }}</span></td>
                                        </tr>
                                        <tr>
                                            @foreach ($users as $user)
                                                @if ($alumnos->creado_por)
                                                <th>Inscripto por:</th> 
                                                <td>  <span class="badge badge-dark">{{ $alumnos->creado_por}}</span></td>
                                                @elseif ($alumnos->actualizado_por)
